...
async function scrapeBrown({ hotelName, checkIn, checkOut, adults, children }) {
  return withRetry(async () => {
    ...
    try {
      ...
      const url = `https://www.brownhotels.com/search?checkIn=${checkIn}&checkOut=${checkOut}&adults=${adults}&children=${children}`;
