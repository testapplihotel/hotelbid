...
async function scrapeAstral({ hotelName, checkIn, checkOut, adults, children }) {
  return withRetry(async () => {
    ...
    try {
      ...
      const url = `https://www.astral-hotels.com/en/search?checkIn=${checkIn}&checkOut=${checkOut}&adults=${adults}&children=${children}`;
      ...
      return [{
        source: 'astral-hotels.com',
        hotel: hotelName,
        prix_total: Math.min(...results),
        devise: 'ILS',
